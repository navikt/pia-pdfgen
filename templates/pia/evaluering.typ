...
#let data = json("/data/pia/evaluering.json")
...
#let dokument-tittel = "Evaluering" + "-" + samarbeid.navn + "-" + str(samarbeid.id)
...
#show heading.where(level: 1): set text(size: 26pt, weight: "bold") // Gjennomført evaluering
...
Resultatene fra evalueringen er sortert på tema og spørsmål.
